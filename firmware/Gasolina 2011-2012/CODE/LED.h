...
*/
#define LED_GetVal() ( \
    (bool)((getReg8(PTDD) & 0x20))     /* Return port data */ \
  )
...
*/
#define LED_ClrVal() ( \
    (void)clrReg8Bits(PTDD, 0x20)      /* PTDD5=0x00 */ \
  )
...
*/
#define LED_SetVal() ( \
    (void)setReg8Bits(PTDD, 0x20)      /* PTDD5=0x01 */ \
  )
...
*/
#define LED_NegVal() ( \
    (void)invertReg8Bits(PTDD, 0x20)   /* PTDD5=invert */ \
  )
